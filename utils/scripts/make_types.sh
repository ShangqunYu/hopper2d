...
rm */*.pyc
rm */*.cs
rm ../simulator/unity_Visualization/Assets/lcm-types/*.cs
rm ../simulator/unity_Visualization/Assets/lcm-types/*.cs.meta
...
cp csharp/*.cs ../simulator/unity_Visualization/Assets/lcm-types
