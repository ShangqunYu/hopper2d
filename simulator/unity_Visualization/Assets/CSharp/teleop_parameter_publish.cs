...
public class teleop_parameter_publish : MonoBehaviour {

  LCM.LCM.LCM myLCM;
  LCMTypes.teleop_parameters_lcmt msg = new LCMTypes.teleop_parameters_lcmt();
  LCMTypes.teleop_menu_data_lcmt menuMsg = new LCMTypes.teleop_menu_data_lcmt();
  ...
  void Update () {
    ...
    if(push_button){
      myLCM.Publish("teleop_parameters", msg);
      myLCM.Publish("teleop_menu_data", menuMsg);
    }
