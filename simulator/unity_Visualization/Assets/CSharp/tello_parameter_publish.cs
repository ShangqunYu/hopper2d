...
public class tello_parameter_publish : MonoBehaviour {

  LCM.LCM.LCM myLCM;
  LCMTypes.tello_parameters_lcmt msg = new LCMTypes.tello_parameters_lcmt();
  LCMTypes.tello_menu_data_lcmt menuMsg = new LCMTypes.tello_menu_data_lcmt();
  ...
  void Update () {
    ...
    if(push_button){
      myLCM.Publish("tello_parameters", msg);
      myLCM.Publish("tello_menu_data", menuMsg);
    }
