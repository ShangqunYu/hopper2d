...
public class MenuData : MonoBehaviour
{
    ...
    public void setValues(){
      ...
      GameObject.Find("cheater_mode_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.cheater_mode;

      GameObject.Find("use_wbc_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.use_wbc;
      GameObject.Find("use_rc_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.use_rc;

      GameObject.Find("display_heightmap_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.display_heightmap;
      GameObject.Find("display_path_planning_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.display_path_planning;
      GameObject.Find("display_potential_field_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.display_potential_field;
      GameObject.Find("display_traversability_toggle").GetComponent<UnityEngine.UI.Toggle>().isOn = data.display_traversability;

      //TODO: fix finding these on inactive pages
      GameObject.Find("Kd_body_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kd_body.ToString("N3");
      GameObject.Find("Kd_cam_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kd_cam.ToString("N3");
      GameObject.Find("Kd_clm_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kd_clm.ToString("N3");
      GameObject.Find("Kd_foot_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kd_foot.ToString("N3");
      GameObject.Find("Kd_joint_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kd_joint.ToString("N3");
      GameObject.Find("Kd_ori_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kd_ori.ToString("N3");

      GameObject.Find("Kp_body_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kp_body.ToString("N3");
      GameObject.Find("Kp_cam_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kp_cam.ToString("N3");
      GameObject.Find("Kp_clm_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kp_clm.ToString("N3");
      GameObject.Find("Kp_foot_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kp_foot.ToString("N3");
      GameObject.Find("Kp_joint_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kp_joint.ToString("N3");
      GameObject.Find("Kp_ori_input_field").GetComponent<UnityEngine.UI.InputField>().text = data.Kp_ori.ToString("N3");
