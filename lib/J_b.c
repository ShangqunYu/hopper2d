...
#else
  #define CASADI_PREFIX(ID) J_b_ ## ID
#endif
...
static const casadi_int casadi_s2[21] = {3, 6, 0, 1, 2, 5, 8, 11, 12, 0, 1, 0, 1, 2, 0, 1, 2, 0, 1, 2, 2};

/* J_b:(i0[12],i1[17])->(o0[3x6,12nz]) */
...
CASADI_SYMBOL_EXPORT casadi_int J_b_n_in(void) { return 2;}
